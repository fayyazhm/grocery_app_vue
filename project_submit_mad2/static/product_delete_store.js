...
const product_delete_store= Vue.component("product_deleteconfirm",{
    template:`
    ...
    methods:{
      dele(){
        ...
        data=>{
          if (data=="error"){
            console.log(data)
            this.$router.push('/product/delete/error/'+this.product_name_new.toUpperCase())
          }
...
export default product_delete_store