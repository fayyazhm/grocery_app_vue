const user_advsearch_page = Vue.component("user_advasearch_page",{
    template:`
    <div>
    ...
    mounted(){
        console.log("advsearchpage")
        fetch(`/user/advsearch/${this.c}/${this.d}/${this.e}`).then((response)=>{return response.json()}).
        then((data)=>
        {
            this.user=data["user"]
            this.cat=data["cat"]
...
export default user_advsearch_page